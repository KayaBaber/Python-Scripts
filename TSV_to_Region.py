...
errRADIIlistB = error_function(OFFSETlist, BROADCOUNTlist)
errRADIIlistM = error_function(OFFSETlist, MEDCOUNTlist)
...
save_region(inputTSV, NAMElist, RAlist, DEClist, errRADIIlistB, extra="_B")
save_region(inputTSV, NAMElist, RAlist, DEClist, errRADIIlistM, extra="_M")
   
   
print("Done! Region files saved in same directory as TSV.")